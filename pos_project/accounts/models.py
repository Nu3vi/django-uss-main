...
#from pos_project.accounts.helpers import photo_path_aws_instance
#from pos_project.accounts.constants import OPERADORES
...
def photo_path_aws_instance(instance, filename):
    ...
    return f"usuarios/avatars/{instance.username}/{unique_filename}"
